...
class SolrUtil {
    ...
    def static
    final IGNORED_PROPS = ["attached", "errors", "constraints", "metaClass", "log", "class", "version", "id", "hasMany", "domainClass"]
    ...
    */
    ...
    def static
    final typeSuffixes = ["_i", "_s", "_l", "_t", "_b", "_f", "_d", "_dt", "_ti", "_tl", "_tf", "_td", "_tdt", "_pi"]
